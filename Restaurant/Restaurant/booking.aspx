                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="form-floating date" id="date3" data-target-input="nearest">
                                        <asp:TextBox ID="txt_datetime" runat="server" class="form-control datetimepicker-input" placeholder="Date & Time"
                                            data-target="#date3" data-toggle="datetimepicker" OnTextChanged="txt_datetime_TextChanged" required></asp:TextBox>
